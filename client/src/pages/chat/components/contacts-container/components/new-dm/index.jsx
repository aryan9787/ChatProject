...
const NewDM = () => {
  ...
  const selectNewContact = (contact) => {
    // logic to select new contact and start a new chat
    ...
    <>
      ...
      <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
        ...
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1 md:bg-[#1c1d25] md:flex flex-col items-center justify-center duration-1000 transition-all mt-10 md:mt-5">
              <Lottie
              ...
              />
              <div className="text-opacity-80 text-white flex flex-col gap-2 items-center mt-5  lg:text-1xl text-xl transition-all duration-300 text-center">
